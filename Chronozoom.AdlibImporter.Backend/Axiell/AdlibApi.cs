...
namespace Chronozoom.AdlibImporter.Backend.Axiell
{
    public class AdlibApi
    {
        ...
        {
            var uri = String.Format("{0}/wwwopac.ashx?database={1}&command=facets&search=all&facet={2}&xmltype=unstructured&limit=2000", url, database, facet); //limit=5&startfrom=95
